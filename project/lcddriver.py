...
class lcd:
   ...
   # put string function
   def lcd_display_stringg(self, string, line,column):
      if line == 1:
         self.lcd_write(0x80 + column)
      if line == 2:
         self.lcd_write(0xC0 + column)
      if line == 3:
         self.lcd_write(0x94 + column)
      if line == 4:
         self.lcd_write(0xD4 + column)
